...
/// Marked 'use client' because it imports Counter which uses reactive streams.
            ...
            Html.div [
                ...
                prop.children [
                    Html.h1 [
                        ...
                        prop.text "NextFs + Reaction"
                    ]
                    Html.p [
                        prop.style [ style.margin (8, 0, 0, 0); style.color "#64748b"; style.fontSize 13 ]
                        prop.text "Async reactive streams running inside a Next.js App Router client component"
                    ]
                ]
            ]
            Counter()
